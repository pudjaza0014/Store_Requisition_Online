<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Frm_Report_Date.aspx.cs" Inherits="Frm_Report_Date" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="Div0" runat="server">
        <fieldset style="width: 100%; margin: auto; padding: 0">
            <legend>Store&#39;s Material Requisition Report By Date</legend>
            <table class="auto-style5">
                <tr>
                    <td style="width: 40%;" class="auto-style1">
                        <strong>
                            <asp:Label ID="Label29" runat="server" Font-Names="Century Gothic" Text="Date From : "></asp:Label>
                        </strong>
                    </td>
                    <td style="width: 60%;">
                        ...
                        <strong>
                            <asp:Label ID="Label52" runat="server" Font-Names="Century Gothic" Text="ex : 01/11/2021 " CssClass="auto-style6"></asp:Label>
                        </strong>
                    </td>
                </tr>
                <tr>
                    <td style="width: 40%;" class="auto-style1">
                        <strong>
                            <asp:Label ID="Label50" runat="server" Font-Names="Century Gothic" Text="Date To : "></asp:Label>
                        </strong>
                    </td>
                    <td style="width: 60%;">
                        ...
                        <strong>
                            <asp:Label ID="Label53" runat="server" Font-Names="Century Gothic" Text="ex : 10/11/2021 " CssClass="auto-style6"></asp:Label>
                        </strong>
                    </td>
                </tr>
                <tr>
