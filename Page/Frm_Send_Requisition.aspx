    ...
    <div id="Div0" runat="server">
        <fieldset style="width: 100%; margin: auto; padding: 0">
            ...
            <table class="auto-style5">
                ...
                <tr>
                    <td style="width: 40%;" class="auto-style1"><strong>
                        <asp:Label ID="Label49" runat="server" Font-Names="Century Gothic" Text="Type : "></asp:Label>
                    </strong>
                    </td>
                    <td style="width: 60%;">
                        <asp:DropDownList ID="ddlType" runat="server" AutoPostBack="True" Width="300px" OnSelectedIndexChanged="ddlType_SelectedIndexChanged" Font-Names="Century Gothic">
                            <asp:ListItem>Please Select ...</asp:ListItem>
                            <asp:ListItem>Chemical</asp:ListItem>
                            <asp:ListItem>RM temp 0 - 5c</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 60%;">
                        <asp:DropDownList ID="ddlRoundTime" runat="server" AutoPostBack="True" Width="300px" OnSelectedIndexChanged="ddlRoundTime_SelectedIndexChanged" Font-Names="Century Gothic" Enabled="False">
                            <asp:ListItem>Please Select ...</asp:ListItem>
                ...
                <fieldset style="width: 100%; margin: auto; padding: 0">
                    ...
                    <table style="width: 100%;"> 
                        <tr> 
                             <td>&nbsp;</td>
                            <td>
                                <asp:GridView ID="dgvLFRequisitionList" runat="server" AutoGenerateColumns="false" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Names="Century Gothic" Font-Size="8pt" HorizontalAlign="Center" ShowFooter="True" Width="60%" OnRowCommand="dgvLFRequisitionList_RowCommand">
                                    <Columns> 
                                        <asp:ButtonField Text="Select" CommandName="SL" HeaderText="Action"   ControlStyle-ForeColor="blue" ItemStyle-VerticalAlign="Middle" />
                                       <asp:BoundField DataField="REQ_NUM" HeaderText="RequisitionNo." />
                                        <asp:BoundField DataField="PROGRESS" HeaderText="Status." />
                                        <asp:BoundField DataField="REQ_BY" HeaderText="Request by ." />
                                        <asp:BoundField DataField="REQ_BY_TEL" HeaderText="Request by tel ." />
                                        <asp:BoundField DataField="REQ_LOCATION" HeaderText="Location." />
                                        <asp:BoundField DataField="TRANSFER_TO" HeaderText="Transfer to." />
                                        <asp:BoundField DataField="DELIVERY_STATION" HeaderText="Delivery Station." />
                                    </Columns> 
